...
class QLearningSolver(BaseSolver):
    def __init__(self, env, max_episodes=2000, max_steps_per_episode=1000, discount_factor=1.0, alpha=0.5, epsilon=0.1,
                 epsilon_decay=0.001, q_init=0, theta=0.001, min_consecutive_sub_theta_episodes=5, verbose=False):
