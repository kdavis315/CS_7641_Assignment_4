...
if __name__ == '__main__':
    ...
    envs = [
        {
            'env': environments.get_rewarding_minesweeper_environment(),
            'name': 'minesweeper',
            'readable_name': 'Minesweeper (8x8)',
        },
        {
            'env': environments.get_large_rewarding_minesweeper_environment(),
            'name': 'large_minesweeper',
            'readable_name': 'Minesweeper (20x20)',
        },
        {
            'env': environments.get_robot_vacuum_environment(),
            'name': 'robot_vacuum',
            'readable_name': 'Robot Vacuum (15x15)',
        }
    ]
    
    # envs = [
    #     {
    #         'env': environments.get_rewarding_no_reward_minesweeper_environment(),
    #         'name': 'minesweeper',
    #         'readable_name': 'Minesweeper (8x8)',
    #     },
    #     {
    #         'env': environments.get_large_rewarding_no_reward_minesweeper_environment(),
    #         'name': 'large_minesweeper',
    #         'readable_name': 'Minesweeper (20x20)',
    #     },
    #     {
    #         'env': environments.get_robot_vacuum_no_reward_environment(),
    #         'name': 'robot_vacuum',
    #         'readable_name': 'Robot Vacuum (15x15)',
    #     }
    # ]
